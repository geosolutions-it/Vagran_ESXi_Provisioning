...
Vagrant.configure('2') do |config|
  ...
  #config.vm.network 'public_network', ip: '51.89.27.40'#, mac: '00:50:56:04:4c:22'
  ...
  config.vm.provider :vmware_esxi do |esxi|
    ...
    esxi.esxi_hostname = '145.239.232.142'
    ...
    esxi.guest_virtualhw_version = '10'
